      ...
      <section className="py-20 px-4 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link 
              href="/register" 
              className="bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-lg text-xl transition-colors duration-300 transform hover:scale-105 hover:shadow-xl"
            >
              🏆 Register Now & Win
            </Link>
            <Link 
              href="/login" 
              className="bg-green-600 hover:bg-green-700 text-white font-bold py-3 px-6 rounded-lg text-lg transition-colors duration-300 transform hover:scale-105 hover:shadow-lg"
            >
              👥 Login
            </Link>
          </div>
